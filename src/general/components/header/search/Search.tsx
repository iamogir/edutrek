...
const Search = () => {
    return (
        <div className={style.box}>
            <svg xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 -960 960 960" width="24px" fill="#f8f8f8">
                <path
            ...
            <input type={"text"} name={"search"} placeholder={"Search"} className={style.in}/>
        </div>
